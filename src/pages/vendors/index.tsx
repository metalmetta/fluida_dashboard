      ...
      <div className="space-y-6">
        ...
        <Card>
          <div className="p-6 space-y-6">
            {isAddingVendor && <div className="add fields: wallet address, bank details, address">
                <h3 className="font-medium">Add New Vendor</h3>
                <div className="space-y-4">
                  <Input placeholder="Vendor Name" value={newVendor.name} onChange={e => setNewVendor({
                ...newVendor,
                name: e.target.value
              })} />
                  <Input type="email" placeholder="Email Address" value={newVendor.email} onChange={e => setNewVendor({
                ...newVendor,
            ...
            <div className="divide-y">
              {vendors.map(vendor => <div key={vendor.id} className="flex items-center justify-between py-4">
                  <div className="flex items-center gap-4">
                    <Avatar />
                    {editingVendor === vendor.id ? <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {editingVendor === vendor.id ? <div className="flex gap-2">
                    ...
                    setEditForm(null);
                      ...
                      </div> : <Button size="sm" variant="ghost" onClick={() => handleEditVendor(vendor.id)}>
